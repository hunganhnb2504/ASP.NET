...
builder.Services.AddDefaultIdentity<WebApplication5User>(options => options.SignIn.RequireConfirmedAccount = true).AddEntityFrameworkStores<WebApplication5Context>();
